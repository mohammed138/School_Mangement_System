...
namespace School.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (!await _roleManager.RoleExistsAsync(WC.MangerRole))
            {
                await _roleManager.CreateAsync(new IdentityRole(WC.MangerRole));
                await _roleManager.CreateAsync(new IdentityRole(WC.StudentRole));
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (User.IsInRole(WC.MangerRole))
                    {

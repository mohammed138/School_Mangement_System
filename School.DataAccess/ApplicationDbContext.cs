...
namespace School.DataAccess
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Class>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<Decisions>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<Duration>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<Skills>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<SkillsBehavior>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<SkillsType>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<Student>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<Subject>().HasQueryFilter(p => !(bool)p.IsDelete);
            builder.Entity<Teacher>().HasQueryFilter(p => !(bool)p.IsDelete);
            ...
            builder.Entity<Decisions>().HasData(new Decisions { Id = 3, AllowToCreatMarks = false , AllowToUpdatedMarks =false}   );
            ...
            builder.Entity<Class>().HasData(
                new Class { Id = 1010, Name = " الصف الأول " },
            new Class { Id = 1020, Name = " الصف الثاني      " },
            new Class { Id = 1030, Name = "  الصف الثالث  " },
            new Class { Id = 1040, Name = "   الصف الرابع " },
            new Class { Id = 1050, Name = "  الصف الخامس  " },
            new Class { Id = 1060, Name = "  الصف السادس  " },
            new Class { Id = 1070, Name = "   الصف السابع " },
            new Class { Id = 1080, Name = " الصف الثامن" },
            new Class { Id = 1090, Name = "   الصف التاسع " },
            new Class { Id = 1100, Name = " الصف العاشر " },
            new Class { Id = 115, Name = "   الصف الحادي عشر أدبي" },
            new Class { Id = 116, Name = "  الصف الحادي عشر علمي" },
            new Class { Id = 117, Name = "   الصف الثاني عشر أدبي " },
            new Class { Id = 118, Name = "   الصف الثاني عشر علمي  " }
            );

            // builder
            //     .Entity<Subject>().HasData(
            //// مواد الصف الأول 
            //new Subject { Id = 100, Name = " 	لغة عربية  ",            ClassId = 1010 , TeacherId= 100 },
            //new Subject { Id = 200, Name = "  لغة انجليزية  ",          ClassId = 1010, TeacherId = 500 },
            //new Subject { Id = 300, Name = "تربية وطنية وحياتية ",      ClassId = 1010, TeacherId = 100 },
            //new Subject { Id = 400, Name = " تربية إسلامية ",            ClassId = 1010, TeacherId = 100 },
            //new Subject { Id = 500, Name = " 	حاسوب  ",                ClassId = 1010, TeacherId = 100 },
            //new Subject { Id = 600, Name = "الرياضيات",                 ClassId = 1010, TeacherId = 100 },
            //// مواد الصف الثاني
            ...
            //new Teacher { Id = 100, FirstName = "ألاء",      LastName= "أبو شعير",  }, 
